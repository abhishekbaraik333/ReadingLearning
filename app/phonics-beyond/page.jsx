...
export default function PhonicsBeyond() {
  ...
  return (
    <div className="w-full flex flex-col items-center overflow-x-hidden">
      ...
      >
        <h1 className="text-[26px] font-bold text-[#221750] text-center leading-tight mb-8">
          Phonics and beyond!
        </h1>

        <div className="w-full flex justify-center mb-8 relative">
          {/* Decorative star background simulated by image or container */}
          <img 
            src="/phonics.webp" 
        ...
        <p className="text-[18px] text-center text-[#221750] font-medium mb-8 px-2 leading-snug">
          Phonics-based methods are better because they adhere to how the brain actually learns to read.
        </p>
